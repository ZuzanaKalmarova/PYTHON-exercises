...
class Ship:
    ...
    def thruster(self,thrust_value):
        if thrust_value:
            self.thrust = True
    ...
    def shoot(self):
        ...
        pos = [0,0]
        vel = [0,0]
        pos[0] = my_ship.pos[0] + my_ship.forward[0] * my_ship.radius
        pos[1] = my_ship.pos[1] + my_ship.forward[1] * my_ship.radius
        vel[0] = my_ship.vel[0] + my_ship.forward[0] * 5
        vel[1] = my_ship.vel[1] + my_ship.forward[1] * 5
...
def rock_spawner():
    ...
    vel[0] = random.random()*4 - 2
    vel[1] = random.random()*4 - 2
