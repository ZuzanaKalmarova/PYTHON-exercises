...
def draw(canvas):
    ...
    canvas.draw_polygon([[0,paddle1_pos+HALF_PAD_HEIGHT],[PAD_WIDTH,paddle1_pos+HALF_PAD_HEIGHT],
                         [PAD_WIDTH, paddle1_pos-HALF_PAD_HEIGHT],[0,paddle1_pos-HALF_PAD_HEIGHT]],1,
                        'white', 'white')
    canvas.draw_polygon([[WIDTH-PAD_WIDTH,paddle2_pos+HALF_PAD_HEIGHT],[WIDTH,paddle2_pos+HALF_PAD_HEIGHT],
                         [WIDTH, paddle2_pos-HALF_PAD_HEIGHT],[WIDTH-PAD_WIDTH,paddle2_pos-HALF_PAD_HEIGHT]],1,
                        'white', 'white')
...
frame.add_button('Reset', button, 100)
